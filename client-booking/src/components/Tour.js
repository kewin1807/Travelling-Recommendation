...
export default function Tour({ tour }) {
    const { tour_name, tour_id, image, link, price, rating, number_people_rating, start_date, start_hour, number_available_seat, number_days } = tour;
    ...
    return (
        <article className="room">
            ...
            <div style={{ padding: 10 }}>
                <p className="room-info">{tour_name}</p>
                <p> Mã tour: {tour_id} </p>
